...
# from common.data import load_dataset, get_grouped_data
# from common.header import header_layout
# from common.mapping import intent_options, causes_options, state_options, map_scale_options, analytics_options
...
#
# print(os.getcwd())
# df_mortality_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_final_v2.feather')
# df_mortality_csv_path = os.path.join('.', 'data', 'MortalityData_2001_2018_final_v2.csv')
# df_mortality_state_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_SG_v2.feather')
# df_mortality_county_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_CG_v2.feather')
# df_mortality_region_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_RG_v2.feather')
#
# year_series, year_options, year_options_max, year_options_min, df_mortality_global = load_dataset(df_mortality_feather_path,
#                                                                              df_mortality_csv_path,
...
#                 dcc.Dropdown(
#                     id='file_drop_down',
#                     options=[{'value': 'MortalityData_2001_2018_Final_v2.csv', 'label': 'MortalityData_2001_2018_Final_v2.csv'}],
#                     placeholder='Select',
#                     multi=False,
#                     optionHeight=60,
#                     value='MortalityData_2001_2018_Final_v2.csv'
#                 ),
#             ], id='file_drop_down_label', className='six columns'),
#
#         ], className='row'),
#         html.Div([
#             html.Div([
...
#                         cause, intent, state, show_all, limit, metric):
#     """
#         Creates and caches data for a increases/decreases tables
#     """
#     print(analytics_option)
#     alert_value = ''
#     error = False
#
#     year1 = year - 1
...
#         _, df, _ = get_grouped_data(df_mortality_global)
#         location = 'County_Name_Full'
#     elif tab_scale == 'state':
#         df, _, _ = get_grouped_data(df_mortality_global)
#         location = 'State_name'
#     else:
#         _, _, df = get_grouped_data(df_mortality_global)
...
#
#
# def get_testing_file():
#     filenames = os.listdir(os.path.join('.', 'data', 'testing'))
#     return [{'label': filename, 'value': filename} for filename in filenames if filename.endswith('.csv')]
#
# @app.callback(
#     dash.dependencies.Output('file_drop_down', 'options'),
#     dash.dependencies.Input('my-toggle-switch', 'value')
# )
# def update_file_options(value):
#     if value:
#         return [{'label': 'MortalityData_2001_2018_Final_v2.csv', 'value': 'MortalityData_2001_2018_Final_v2.csv'}] + get_testing_file()
#     else:
#         return [{'label': 'MortalityData_2001_2018_Final_v2.csv', 'value': 'MortalityData_2001_2018_Final_v2.csv'}]
#
# # @app.callback(
# #     dash.dependencies.Output('State', 'options'),
# #     dash.dependencies.Output('Intent', 'options'),
# #     dash.dependencies.Output('Cause', 'options'),
# #     dash.dependencies.Output('Year', 'options'),
# #     dash.dependencies.Input('file_drop_down', 'options')
# # )
#
#
# @app.callback(
...
#      dash.dependencies.Input('file_drop_down', 'value')]
# )
# def update_table(tab_scale, analytics_option, year, years_base, years_comparison,
#                  cause, intent, state, show_all, limit, metric, file_drop_down):
#     """
#         Input callback handler
#     """
#     # print("I am inside update table")
#     # global year_series, year_options, year_options_max, year_options_min, df_mortality_global
#     # global df_mortality_csv_path, df_mortality_region_feather_path, df_mortality_county_feather_path, df_mortality_state_feather_path, df_mortality_feather_path
#     # print(file_drop_down)
#     # if file_drop_down == "MortalityData_2001_2018_Final_v2.csv":
#     #     df_mortality_csv_path = os.path.join('.', 'data', 'MortalityData_2001_2018_Final_v2.csv')
#     #     df_mortality_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_Final_v2.feather')
#     #     df_mortality_state_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_SG_v2.feather')
#     #     df_mortality_county_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_CG_v2.feather')
#     #     df_mortality_region_feather_path = os.path.join('.', 'data', 'MortalityData_2001_2018_RG_v2.feather')
#     #     year_series, year_options, year_options_max, year_options_min, df_mortality_global = load_dataset(
#     #         df_mortality_feather_path,
#     #         df_mortality_csv_path,
#     #         df_mortality_state_feather_path,
#     #         df_mortality_county_feather_path,
#     #         df_mortality_region_feather_path)
#     # else:
#     #     base_name = file_drop_down.rstrip('.csv')
#     #     df_mortality_csv_path = os.path.join('.', 'data', 'testing', file_drop_down)
#     #     df_mortality_feather_path = os.path.join('.', 'data', 'testing', f'{base_name}.feather')
#     #     df_mortality_state_feather_path = os.path.join('.', 'data', 'testing', f'{base_name}_SG.feather')
#     #     df_mortality_county_feather_path = os.path.join('.', 'data', 'testing', f'{base_name}_CG.feather')
#     #     df_mortality_region_feather_path = os.path.join('.', 'data', 'testing', f'{base_name}_RG.feather')
#     #     year_series, year_options, year_options_max, year_options_min, df_mortality_global = load_dataset(
#     #         df_mortality_feather_path,
#     #         df_mortality_csv_path,
#     #         df_mortality_state_feather_path,
...
#     #
#     #     )
#     print("I am here before populate table data")
#     return populate_table_data(tab_scale, analytics_option, year,
#                                years_base, years_comparison, cause, intent, state, show_all, limit, metric)
#
#
# @app.callback(
...
def populate_table_data(tab_scale, analytics_option, year, years_base, years_comparison,
    ...
    if tab_scale == 'county_fips':
        ...
        df = df.groupby(by=['region', 'Region_name', 'age_range', 'race', 'sex', 'ethnicity', 'cause', 'intent', 'age_range_all', 'race_all', 'sex_all', 'ethnicity_all'])[2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018].sum()
        # print(df[['region', 'Region_name', 'age_range', 'race', 'sex', 'ethnicity', 'cause', 'intent']])
        location = 'Region_name'
