...
from app import app
from apps import metric_vs_time_view, map_view, table_view, data_upload_view
...
def display_page(pathname):
    if pathname == '/apps/metric-vs-time-view':
        ...
        return table_view.layout
    elif pathname == '/apps/data-upload-view':
        return data_upload_view.layout
    else:
        return metric_vs_time_view.layout
